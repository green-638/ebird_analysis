...
## Analysis
The analysis tab in data.xlsx describes where each species has been found and how many times they've been reported at each location, the relationship between species quantity and time and date, the correlation between checklist quantity and species quantity, and the checklist quantity and species quantity at each location. It includes a record lookup, which finds the latest record of a specified species.
